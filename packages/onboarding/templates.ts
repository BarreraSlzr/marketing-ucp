...
const subscriptionWebhookUrl = process.env.NEXT_PUBLIC_SITE_URL
  ? `${process.env.NEXT_PUBLIC_SITE_URL}/api/webhooks/subscription`
  : undefined;

const integrationConfigWebhookUrl = process.env.NEXT_PUBLIC_SITE_URL
  ? `${process.env.NEXT_PUBLIC_SITE_URL}/api/webhooks/integration-config`
  : undefined;
...
export const ONBOARDING_WEBHOOK_CONFIG: OnboardingTemplate = {
  id: "webhook-config",
  name: "Webhook Configuration",
  description:
    "Register webhook endpoints, secrets, and event subscriptions for callbacks.",
  category: "integration",
  regions: ["global"],
  docsUrl:
    "https://github.com/BarreraSlzr/marketing-ucp/blob/main/docs/webhook-api-integration-forms.md",
  fields: [
    {
      key: "webhookName",
      label: "Webhook Name",
      type: "text",
      placeholder: "Order status updates",
      description: "Friendly label to identify this webhook endpoint",
      required: true,
      group: "endpoint",
      order: 0,
    },
    {
      ...
      label: "Callback URL",
      type: "url",
      placeholder: "https://api.example.com/webhooks/ucp",
      description: "Public HTTPS endpoint that will receive webhook events",
      required: true,
      group: "endpoint",
      envVar: "UCP_WEBHOOK_CALLBACK_URL",
      order: 1,
    },
    {
      ...
      type: "multi_select",
      description: "Select all event types you want delivered",
      required: true,
      options: [
        ...
        { label: "Refund Updated", value: "refund.updated" },
        ...
        { label: "Payout Paid", value: "payout.paid" },
    ...
    },
    {
      ...
      required: true,
      group: "security",
      envVar: "UCP_WEBHOOK_SIGNING_SECRET",
      order: 0,
    },
    {
      key: "deliveryMode",
      label: "Delivery Mode",
      type: "select",
      description: "Delivery guarantees for webhook retries",
      required: true,
      defaultValue: "at_least_once",
      options: [
        { label: "At least once (retry on failure)", value: "at_least_once" },
        { label: "Best effort (no retry)", value: "best_effort" },
      ],
      group: "delivery",
      order: 0,
    },
    {
      ...
      required: false,
      pattern: "^\\d{1,2}$",
      patternMessage: "Use a number between 0 and 99",
      group: "delivery",
      order: 1,
    },
  ],
  webhookUrl: integrationConfigWebhookUrl,
  version: "2026-02-08",
};

/* ── Integration: API Key Management ─────────────────────── */
export const ONBOARDING_API_KEY_MANAGEMENT: OnboardingTemplate = {
  id: "api-key-management",
  name: "API Key Management",
  description:
    "Create, rotate, or revoke API keys and scopes for integrations.",
  category: "integration",
  regions: ["global"],
  docsUrl:
    "https://github.com/BarreraSlzr/marketing-ucp/blob/main/docs/webhook-api-integration-forms.md",
  fields: [
    {
      ...
      options: [
        ...
        { label: "Rotate existing key", value: "rotate" },
        { label: "Revoke key", value: "revoke" },
      ],
      group: "request",
      order: 0,
    },
    {
      ...
      description: "Short label to identify this API key",
      required: true,
      group: "request",
      order: 1,
    },
    {
      key: "keyId",
      label: "Key ID (for rotate/revoke)",
      type: "text",
      placeholder: "key_...",
      description: "Provide the key ID when rotating or revoking",
      required: false,
      group: "request",
      order: 2,
    },
    ...
    },
    {
      ...
      label: "Scopes",
      type: "multi_select",
      description: "Select the permissions this key should have",
      required: true,
      options: [
        { label: "Payments Read", value: "payments.read" },
        { label: "Payments Write", value: "payments.write" },
        { label: "Webhooks Read", value: "webhooks.read" },
        { label: "Webhooks Write", value: "webhooks.write" },
        { label: "Refunds Write", value: "refunds.write" },
        { label: "Payouts Read", value: "payouts.read" },
        { label: "Customers Read", value: "customers.read" },
        { label: "Customers Write", value: "customers.write" },
    ...
    },
    {
      ...
      type: "text",
      placeholder: "90",
      description: "Optional expiration window for this key",
      required: false,
      pattern: "^\\d{1,4}$",
      patternMessage: "Use a numeric value in days",
      group: "access",
      order: 2,
    },
    {
      ...
      description: "Send key events and audit notices to this address",
      required: false,
      group: "notifications",
      order: 0,
    },
...
export const ONBOARDING_AUTOMATION_ENDPOINTS: OnboardingTemplate = {
  id: "automation-endpoints",
  name: "Automation Endpoints",
  description:
    "Configure automation callbacks, retry behavior, and workflow toggles.",
  category: "automation",
  regions: ["global"],
  docsUrl:
    "https://github.com/BarreraSlzr/marketing-ucp/blob/main/docs/webhook-api-integration-forms.md",
  fields: [
    {
      key: "profileName",
      label: "Automation Profile Name",
      type: "text",
      placeholder: "Production workflow",
      description: "Label used to identify this automation profile",
      required: true,
      group: "profile",
      order: 0,
    },
    {
      key: "enabledAutomations",
      label: "Enabled Automations",
      type: "multi_select",
      description: "Select the workflows you want to enable",
      required: true,
      options: [
        { label: "Auto capture payments", value: "auto_capture" },
        { label: "Auto refund on failure", value: "auto_refund" },
        { label: "Risk holds", value: "risk_hold" },
        { label: "Fraud screening", value: "fraud_screen" },
        { label: "Send receipts", value: "send_receipts" },
        { label: "Payout reconciliation", value: "payout_reconciliation" },
      ],
      group: "automations",
      order: 0,
    },
    {
      ...
      type: "url",
      placeholder: "https://api.example.com/automation/status",
      description: "Endpoint that receives automation status updates",
      required: false,
      group: "endpoints",
      order: 0,
    },
    {
      key: "riskDecisionUrl",
      label: "Risk Decision URL",
      type: "url",
      placeholder: "https://api.example.com/automation/risk",
      description: "Endpoint to resolve manual risk decisions",
      required: false,
      group: "endpoints",
      order: 1,
    },
    {
      key: "inventorySyncUrl",
      label: "Inventory Sync URL",
      type: "url",
      placeholder: "https://api.example.com/automation/inventory",
      description: "Optional sync endpoint for inventory updates",
      required: false,
      group: "endpoints",
      order: 2,
    },
    {
      ...
      defaultValue: "queue",
      options: [
        { label: "Queue and retry", value: "queue" },
        { label: "Manual intervention", value: "manual" },
        { label: "Drop on failure", value: "drop" },
      ],
      group: "reliability",
      order: 0,
    },
    {
      ...
      description: "Optional header name for endpoint authentication",
      required: false,
      group: "security",
      order: 0,
    },
    {
      ...
      type: "password",
      placeholder: "secret",
      description: "Optional header value for endpoint authentication",
      required: false,
      group: "security",
      order: 1,
    },
...
export const ONBOARDING_MERCHANT_PAYOUT_SCHEDULE: OnboardingTemplate = {
  id: "merchant-payout-schedule",
  name: "Merchant Payout Schedule",
  description:
    "Configure payout frequency, minimum balance thresholds, and preferred settlement timing for merchant disbursements.",
  category: "support",
  regions: ["global"],
  fields: [
    {
    ...
    },
    {
      ...
      type: "select",
      description: "How often payouts should be scheduled",
      required: true,
      defaultValue: "weekly",
      options: [
    ...
    },
    {
      ...
      type: "text",
      placeholder: "500.00",
      description: "Minimum balance required before a payout is triggered",
      required: true,
      pattern: "^\\d+(\\.\\d{1,2})?$",
      patternMessage: "Enter a valid amount (e.g., 500 or 500.00)",
      group: "schedule",
      order: 1,
    },
    {
      ...
      type: "select",
      description: "For weekly/biweekly payouts, select the preferred weekday",
      required: false,
      options: [
    ...
    {
      key: "preferredMonthDay",
      label: "Preferred Day of Month",
      type: "select",
      description: "For monthly payouts, choose the settlement day of month",
      required: false,
      options: [
        { label: "1", value: "1" },
        { label: "2", value: "2" },
    ...
    },
    {
      ...
      type: "select",
      description: "Settlement currency for payouts",
      required: true,
      defaultValue: "MXN",
      options: [
    ...
    },
    {
      ...
      type: "select",
      description: "Timezone used for payout scheduling cutoffs",
      required: true,
    ...
    },
    {
      ...
      description: "Where payout schedule confirmations should be sent",
      required: true,
      group: "notifications",
      order: 0,
    },
    {
      key: "payoutScheduleConsent",
      label: "I confirm this payout schedule is authorized",
      type: "checkbox",
      description: "Confirm that this payout configuration is approved by the merchant",
      required: true,
      group: "consent",
      order: 0,
    },
...
/* ── Merchant Reconciliation Query ───────────────────────── */
export const ONBOARDING_MERCHANT_RECONCILIATION_QUERY: OnboardingTemplate = {
  id: "merchant-reconciliation-query",
  name: "Merchant Reconciliation Search",
  description:
    "Request reconciled transaction and settlement reports filtered by date, handler, and payout status.",
  category: "support",
  regions: ["global"],
  fields: [
    {
    ...
    },
    {
      ...
      description: "Start of the reconciliation window (YYYY-MM-DD)",
      required: true,
      pattern: "^\\d{4}-\\d{2}-\\d{2}$",
      patternMessage: "Use YYYY-MM-DD format",
      group: "date_range",
      order: 0,
    },
    {
      ...
      description: "End of the reconciliation window (YYYY-MM-DD)",
      required: true,
      pattern: "^\\d{4}-\\d{2}-\\d{2}$",
      patternMessage: "Use YYYY-MM-DD format",
      group: "date_range",
    ...
    },
    {
      ...
      type: "select",
      description: "Filter by payment processor or integration (optional)",
      required: false,
      options: [
        { label: "Stripe", value: "stripe" },
        { label: "PayPal MX", value: "paypal-mx" },
        { label: "MercadoPago", value: "mercadopago" },
        { label: "ComproPago", value: "compropago" },
        { label: "STP", value: "stp" },
        { label: "Thirdweb", value: "thirdweb" },
        { label: "Shopify", value: "shopify" },
        { label: "Polar", value: "polar" },
        { label: "Platform (general)", value: "platform" },
      ],
      group: "filters",
      order: 0,
    },
    {
      ...
      type: "select",
      description: "Filter by reconciliation status (optional)",
      required: false,
      options: [
    ...
    },
    {
      ...
      type: "text",
      placeholder: "set_...",
      description: "Specific settlement batch identifier",
      required: false,
      group: "filters",
      order: 2,
    },
    {
      ...
      type: "text",
      placeholder: "pay_...",
      description: "Specific payout reference or transfer ID",
      required: false,
      group: "filters",
      order: 3,
    },
    {
      key: "includeChargebacks",
      label: "Include Disputes/Chargebacks",
      type: "checkbox",
      description: "Include disputed or chargeback transactions in results",
      required: false,
      group: "filters",
      order: 4,
    },
    {
      ...
      label: "Output Format",
      type: "select",
      description: "Preferred format for the reconciliation report",
      required: false,
      defaultValue: "csv",
      options: [
        { label: "CSV", value: "csv" },
    ...
    },
    {
      ...
      description: "Where reconciliation results should be delivered",
      required: true,
      group: "delivery",
      order: 1,
    },
    {
      ...
      type: "textarea",
      placeholder: "Add urgency, delivery context, or special instructions...",
      description: "Use this field to flag urgent requests or provide extra context",
      required: false,
      group: "delivery",
      order: 2,
    },
    {
      key: "reconciliationConsent",
      label: "I confirm this reconciliation request is authorized",
      type: "checkbox",
      description: "Confirm you are authorized to request reconciliation data",
      required: true,
      group: "consent",
      order: 0,
    },
...
/* ── Merchant Invoice / CFDI Request ─────────────────────── */
export const ONBOARDING_MERCHANT_INVOICE_CFDI_REQUEST: OnboardingTemplate = {
  id: "merchant-invoice-cfdi-request",
  name: "Invoice / CFDI Request",
  description:
    "Request a CFDI-compliant invoice for a transaction, including SAT tax identity and payment method details.",
  category: "compliance",
  regions: ["MX"],
  docsUrl: "https://www.sat.gob.mx/consultas/09702/consulta-tu-informacion-fiscal",
  fields: [
    ...
    },
    {
      ...
      type: "text",
      placeholder: "ord_...",
      description: "Order reference associated with this transaction",
      required: false,
      group: "invoice_reference",
      order: 1,
    },
    {
      ...
      required: true,
      pattern: "^\\d+(\\.\\d{1,2})?$",
      patternMessage: "Enter a valid amount (e.g., 1500.00)",
      group: "invoice_reference",
      order: 2,
    },
    {
      ...
      label: "Currency",
      type: "select",
      description: "Currency for the CFDI invoice",
      required: true,
      defaultValue: "MXN",
      options: [
        { label: "MXN — Mexican Peso", value: "MXN" },
    ...
    {
      key: "fiscalName",
      label: "Razón Social / Fiscal Name",
      type: "text",
      placeholder: "Mi Empresa S.A. de C.V.",
      description: "Fiscal name that should appear on the CFDI",
      required: true,
      group: "tax_identity",
      order: 0,
    },
    {
      ...
      type: "text",
      placeholder: "XAXX010101000",
      description: "RFC registered with SAT",
      required: true,
      pattern: "^[A-ZÑ&]{3,4}\\d{6}[A-Z0-9]{3}$",
      patternMessage: "RFC must be 12-13 alphanumeric characters",
      group: "tax_identity",
    ...
    },
    {
      ...
      type: "text",
      placeholder: "03100",
      description: "Fiscal postal code (5 digits)",
      required: true,
      pattern: "^\\d{5}$",
      patternMessage: "Postal code must be 5 digits",
      group: "tax_identity",
      order: 2,
    },
    {
      ...
      label: "Uso de CFDI",
      type: "select",
      description: "Intended CFDI usage",
      required: true,
      defaultValue: "G03",
      options: [
        { label: "G01 - Adquisición de Mercancías", value: "G01" },
    ...
    },
    {
      ...
      type: "select",
      description: "SAT payment method for this invoice",
      required: true,
      defaultValue: "PUE",
      options: [
    ...
    },
    {
      ...
      label: "Forma de Pago",
      type: "select",
      description: "Optional SAT payment form for the invoice",
      required: false,
      options: [
    ...
    },
    {
      ...
      description: "Email to receive the CFDI and PDF",
      required: true,
      group: "delivery",
      order: 0,
    },
    {
      ...
      type: "textarea",
      placeholder: "Any special notes for the invoice...",
      description: "Additional references or instructions for the invoice",
      required: false,
      group: "delivery",
      order: 1,
    },
    {
      key: "invoiceConsent",
      label: "I confirm this invoice request is authorized",
      type: "checkbox",
      description: "Confirm you are authorized to request this CFDI invoice",
      required: true,
      group: "consent",
      order: 0,
    },
...
export const ONBOARDING_SUBSCRIPTION_PLAN_CHANGE: OnboardingTemplate = {
  id: "subscription-plan-change",
  name: "Subscription Plan Change",
  description:
    "Upgrade or downgrade a recurring subscription plan with effective timing and proration controls.",
  ...
  fields: [
    {
      ...
      type: "text",
      placeholder: "sub_...",
      description: "The active subscription to modify",
      required: true,
      group: "subscription",
      order: 0,
    },
    {
      ...
      type: "text",
      placeholder: "cus_...",
      description: "Optional customer reference for this subscription",
      required: false,
      group: "subscription",
      order: 1,
    },
    {
      ...
      description: "Identifier for the existing plan",
      required: true,
      group: "plan",
      order: 0,
    },
    {
      ...
      description: "Identifier for the target plan",
      required: true,
      group: "plan",
      order: 1,
    },
    {
      ...
      options: [
        ...
        { label: "Plan Change", value: "change" },
      ],
      group: "plan",
      order: 2,
    },
    {
      ...
      type: "select",
      required: true,
      defaultValue: "next_cycle",
      options: [
        { label: "Immediately", value: "immediate" },
        { label: "Next Billing Cycle", value: "next_cycle" },
    ...
    {
      key: "customEffectiveDate",
      label: "Custom Effective Date",
      type: "text",
      placeholder: "2026-02-08",
      description: "Use ISO date format if custom timing is selected",
      required: false,
      pattern: "^\\d{4}-\\d{2}-\\d{2}$",
      patternMessage: "Use ISO date format: YYYY-MM-DD",
      group: "timing",
      order: 1,
    },
    {
      ...
      type: "checkbox",
      description: "When enabled, apply proration to the next invoice",
      required: false,
      group: "timing",
      order: 2,
    },
    {
      ...
      required: true,
      options: [
        { label: "Buyer / Subscriber", value: "buyer" },
        { label: "Merchant", value: "merchant" },
        { label: "Operations / Support", value: "ops" },
      ],
      group: "requester",
    ...
    },
    {
      ...
      description: "Email for confirmation and status updates",
      required: true,
      group: "requester",
      order: 1,
    },
    {
      ...
      type: "textarea",
      placeholder: "Reason for plan change or internal notes...",
      description: "Optional notes for this plan change request",
      required: false,
      group: "requester",
      order: 2,
    },
    {
      key: "planChangeConsent",
      label: "I confirm this subscription change is authorized",
      type: "checkbox",
      description: "By checking, you confirm you have permission to change the plan",
      required: true,
      group: "consent",
      order: 0,
    },
...
export const ONBOARDING_SUBSCRIPTION_CANCEL: OnboardingTemplate = {
  id: "subscription-cancel",
  name: "Subscription Cancellation",
  description:
    "Cancel an active subscription with churn reason, timing, and optional feedback.",
  category: "subscription",
  regions: ["global"],
  webhookUrl: subscriptionWebhookUrl,
  fields: [
    ...
    },
    {
      ...
      options: [
        { label: "End of Billing Period", value: "end_of_period" },
        { label: "Immediately", value: "immediate" },
      ],
      group: "timing",
      order: 0,
    },
    {
      ...
      options: [
        ...
        { label: "Not using the product", value: "not_using" },
        { label: "Missing features", value: "missing_features" },
        { label: "Switching to competitor", value: "switching_competitor" },
        { label: "Billing or payment issues", value: "billing_issues" },
        { label: "Support issues", value: "support_issues" },
    ...
    },
    {
      ...
      description: "Optional feedback for churn analysis",
      required: false,
      group: "churn",
      order: 1,
    },
    ...
    },
    {
      ...
      type: "email",
      placeholder: "customer@example.com",
      description: "Email for cancellation confirmation",
      required: true,
      group: "requester",
      order: 1,
    },
    {
      key: "allowFollowUp",
      label: "Allow follow-up on feedback",
      type: "checkbox",
      description: "Consent to be contacted about this cancellation",
      required: false,
      group: "requester",
      order: 2,
    },
    {
      key: "cancelConsent",
      label: "I confirm this cancellation is authorized",
      type: "checkbox",
      description: "By checking, you confirm you are authorized to cancel",
      required: true,
      group: "consent",
      order: 0,
    },
...
export const ONBOARDING_SUBSCRIPTION_PAYMENT_UPDATE: OnboardingTemplate = {
  id: "subscription-payment-update",
  name: "Subscription Payment Update",
  description:
    "Update the payment method used for an active subscription and set default billing details.",
  category: "subscription",
  regions: ["global"],
  webhookUrl: subscriptionWebhookUrl,
  fields: [
    {
      ...
      type: "text",
      placeholder: "sub_...",
      description: "The subscription that will use the new payment method",
      required: true,
      group: "subscription",
      order: 0,
    },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Tokenized Method", value: "token" },
      ],
      group: "payment_method",
      order: 1,
    },
    {
      ...
      type: "text",
      placeholder: "tok_...",
      description: "Token or reference for the new payment method",
      required: true,
      group: "payment_method",
      order: 2,
    },
    {
      ...
      type: "text",
      placeholder: "4242",
      description: "Optional last four digits for card methods",
      required: false,
      pattern: "^\\d{4}$",
    ...
    },
    {
      ...
      description: "Email for payment receipts",
      required: true,
      group: "billing",
      order: 1,
    },
    ...
    },
    {
      ...
      type: "checkbox",
      description: "Make this the default for future renewals",
      required: false,
      group: "billing",
      order: 3,
    },
    {
      key: "paymentUpdateConsent",
      label: "I confirm this payment update is authorized",
      type: "checkbox",
      description: "By checking, you confirm you are authorized to update billing",
      required: true,
      group: "consent",
      order: 0,
    },
...
export const ONBOARDING_SUPPORT_TICKET_CUSTOMER: OnboardingTemplate = {
  id: "support-ticket-customer",
  name: "Customer Support Ticket",
  description:
    "Submit a support request as a customer. Report issues with orders, payments, delivery, or account problems and track resolution.",
  category: "support",
  regions: ["global"],
  fields: [
    {
      ...
      description: "A concise summary of your support request",
      required: true,
      group: "ticket_details",
      order: 0,
    },
    {
      key: "issueType",
      ...
      options: [
        ...
        { label: "Product Defect / Quality", value: "product_defect" },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Normal — Issue affecting my experience", value: "normal" },
        { label: "High — Urgent issue, order at risk", value: "high" },
        { label: "Critical — Payment or security concern", value: "critical" },
      ],
      group: "ticket_details",
      order: 2,
    },
    {
      ...
      type: "text",
      placeholder: "ord_...",
      description: "The order related to this issue, if any",
      required: false,
      group: "ticket_details",
      order: 3,
    },
    {
      ...
      type: "textarea",
      placeholder: "Please describe what happened, when it occurred, and what you expected...",
      description: "Provide as much detail as possible so we can help you quickly",
      required: true,
      group: "details",
      order: 0,
    },
    {
      ...
      label: "Steps to Reproduce (if technical)",
      type: "textarea",
      placeholder: "1. Go to...\n2. Click on...\n3. See error...",
      description: "If this is a technical issue, list the steps that cause the problem",
      required: false,
      group: "details",
      order: 1,
    },
    {
      ...
      description: "We'll send status updates to this email",
      required: true,
      group: "contact",
      order: 0,
    },
    {
      ...
      type: "tel",
      placeholder: "+52 55 1234 5678",
      description: "For urgent issues, provide a phone number",
      required: false,
      group: "contact",
      order: 1,
    },
    {
      ...
      type: "file",
      description: "Upload a screenshot or document related to your issue. Accepted: PDF, JPG, PNG (max 10MB)",
      required: false,
      group: "attachments",
      order: 0,
    },
    {
      key: "consentContact",
      label: "I agree to be contacted regarding this support request",
      type: "checkbox",
      description: "We need your consent to reach out with updates and resolution",
      required: true,
      group: "consent",
      order: 0,
    },
...
/* ── Support Ticket — Merchant ────────────────────────────── */
export const ONBOARDING_SUPPORT_TICKET_MERCHANT: OnboardingTemplate = {
  id: "support-ticket-merchant",
  name: "Merchant Support Ticket",
  description:
    "Submit a support request as a merchant. Report platform issues, integration problems, payout questions, or operational concerns.",
  category: "support",
  regions: ["global"],
  fields: [
    {
    ...
    },
    {
      ...
      required: true,
      options: [
        { label: "Integration / API Issue", value: "integration" },
        { label: "Payout Problem", value: "payout" },
        { label: "Webhook Delivery", value: "webhook" },
        { label: "Dashboard / Analytics", value: "dashboard" },
        { label: "Customer Escalation", value: "customer_escalation" },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Normal — Non-blocking issue", value: "normal" },
        { label: "High — Affecting operations", value: "high" },
        { label: "Critical — Revenue or security impact", value: "critical" },
      ],
      group: "ticket_details",
      order: 2,
    },
    ...
    {
      key: "affectedService",
      label: "Affected Service / Integration",
      type: "select",
      required: false,
      options: [
        { label: "Stripe", value: "stripe" },
    ...
    },
    {
      ...
      label: "Describe Your Issue",
      type: "textarea",
      placeholder: "Describe the problem, including error codes, affected transactions, and timeline...",
      description: "Provide detailed context so our team can investigate efficiently",
      required: true,
      group: "details",
      order: 0,
    },
    {
      key: "errorLogs",
      label: "Error Logs / API Response",
      type: "textarea",
      placeholder: "Paste relevant error messages, stack traces, or API responses...",
      description: "Include any technical details that may help with diagnosis",
      required: false,
      group: "details",
      order: 1,
    },
    {
      key: "transactionIds",
      label: "Affected Transaction IDs",
      type: "textarea",
      placeholder: "txn_abc123, txn_def456...",
      description: "List any transaction or payment IDs related to this issue",
      required: false,
      group: "details",
      order: 2,
    },
    {
      ...
      description: "Primary email for ticket updates",
      required: true,
      group: "contact",
      order: 0,
    },
    {
      ...
      type: "tel",
      placeholder: "+52 55 1234 5678",
      description: "For critical issues requiring immediate response",
      required: false,
      group: "contact",
      order: 1,
    },
    {
      ...
      type: "file",
      description: "Upload screenshots, logs, or documents related to the issue. Accepted: PDF, JPG, PNG, TXT (max 10MB)",
      required: false,
      group: "attachments",
      order: 0,
    },
    {
      key: "consentOps",
      label: "I confirm this report is accurate and submitted by an authorized representative",
      type: "checkbox",
      description: "By checking, you confirm you are authorized to submit tickets on behalf of this merchant account",
      required: true,
      group: "consent",
      order: 0,
    },
...
/* ── Feedback — Post-Purchase Review (Customer) ───────────── */
export const ONBOARDING_FEEDBACK_REVIEW_CUSTOMER: OnboardingTemplate = {
  id: "feedback-review-customer",
  name: "Customer Feedback & Review",
  description:
    "Share your experience after a purchase. Rate the product, service, and checkout experience to help other buyers and improve the platform.",
  category: "feedback",
  regions: ["global"],
  fields: [
    {
      ...
      type: "text",
      placeholder: "ord_...",
      description: "The order you are reviewing",
      required: true,
    ...
    {
      key: "checkoutExperienceRating",
      label: "Checkout Experience",
      type: "select",
      required: false,
      options: [
        { label: "★★★★★ — Seamless", value: "5" },
        { label: "★★★★☆ — Easy", value: "4" },
        { label: "★★★☆☆ — Okay", value: "3" },
        { label: "★★☆☆☆ — Difficult", value: "2" },
        { label: "★☆☆☆☆ — Frustrating", value: "1" },
      ],
      group: "ratings",
      order: 2,
    },
    ...
    },
    {
      ...
      description: "Your feedback helps merchants improve and other buyers make decisions",
      required: false,
      group: "review",
      order: 1,
    },
    {
      key: "wouldRecommend",
      label: "Would you recommend this seller to others?",
      type: "select",
      required: true,
      options: [
    ...
    },
    {
      ...
      type: "file",
      description: "Upload a photo of the product you received. Accepted: JPG, PNG (max 5MB)",
      required: false,
      group: "attachments",
      order: 0,
    },
    {
      ...
      type: "email",
      placeholder: "you@example.com",
      description: "Optional — if the merchant wants to address your feedback",
      required: false,
      group: "contact",
      order: 0,
    },
    {
      key: "consentPublish",
      label: "I agree that this review may be published publicly",
      type: "checkbox",
      description: "Your review may be shown to other buyers on the product page",
      required: true,
      group: "consent",
      order: 0,
    },
...
/* ── Feedback — Merchant Platform Review ──────────────────── */
export const ONBOARDING_FEEDBACK_MERCHANT: OnboardingTemplate = {
  id: "feedback-merchant-platform",
  name: "Merchant Platform Feedback",
  description:
    "Share feedback about the platform as a merchant. Help us improve integrations, tools, and support quality.",
  category: "feedback",
  regions: ["global"],
  fields: [
    {
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Onboarding Experience", value: "onboarding" },
        { label: "Support Quality", value: "support" },
        { label: "Payouts", value: "payouts" },
        { label: "Documentation", value: "documentation" },
        { label: "Overall Platform", value: "overall" },
      ],
      group: "merchant_info",
      order: 1,
    },
    ...
    },
    {
      ...
      type: "textarea",
      placeholder: "What features or tools would help your business?",
      required: false,
      group: "comments",
      order: 2,
    },
    {
      key: "wouldRecommend",
      label: "Would you recommend this platform to other merchants?",
      type: "select",
      required: true,
      options: [
        { label: "Yes, definitely", value: "yes" },
    ...
    },
    {
      ...
      type: "email",
      placeholder: "ops@yourbusiness.com",
      description: "If you'd like us to follow up on your feedback",
      required: false,
      group: "contact",
      order: 0,
    },
    {
      key: "consentFeedback",
      label: "I consent to this feedback being used to improve the platform",
      type: "checkbox",
      description: "Your feedback may be aggregated anonymously for product improvements",
      required: true,
      group: "consent",
      order: 0,
    },
...
export const ALL_ONBOARDING_TEMPLATES: OnboardingTemplate[] = [
  ...
  ONBOARDING_API_KEY_MANAGEMENT,
  ONBOARDING_AUTOMATION_ENDPOINTS,
  ...
  ONBOARDING_SUPPORT_TICKET_CUSTOMER,
  ONBOARDING_SUPPORT_TICKET_MERCHANT,
  ONBOARDING_FEEDBACK_REVIEW_CUSTOMER,
  ONBOARDING_FEEDBACK_MERCHANT,
];
